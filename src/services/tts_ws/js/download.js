...
function downloadTempFile(audioData, sampleRate, oututSampleBits) {
  let wavData = encodeWAV(
    audioData,
    sampleRate || 44100,
    1,
  ...
  return {
    wavBuffer: wavData.buffer,
    url: window.URL.createObjectURL(blob),
    voiceBlob: blob,
    voiceBuffer: audioData.buffer
  };
}

export { downloadWAV, downloadPCM, downloadTempFile };
